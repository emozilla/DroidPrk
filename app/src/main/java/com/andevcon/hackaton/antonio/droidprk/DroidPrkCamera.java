...
// Google doorbell camera example, just renamed;

public class DroidPrkCamera {

    private static final String TAG = "DroidPrk";
    ...
    private DroidPrkCamera() {
    }

    private static class InstanceHolder {
        private static DroidPrkCamera mCamera = new DroidPrkCamera();
    }

    public static DroidPrkCamera getInstance() {
